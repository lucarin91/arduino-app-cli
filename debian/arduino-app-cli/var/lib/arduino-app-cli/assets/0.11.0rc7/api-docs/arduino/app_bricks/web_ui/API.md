...
```python
class WebUI(addr: str, port: int, ui_path_prefix: str, api_path_prefix: str, assets_dir_path: str, certs_dir_path: str, use_tls: bool, use_ssl: bool | None, cors_origins: str)
```
...
#### `expose_camera(path: str, camera: BaseCamera, jpeg_quality: int)`
