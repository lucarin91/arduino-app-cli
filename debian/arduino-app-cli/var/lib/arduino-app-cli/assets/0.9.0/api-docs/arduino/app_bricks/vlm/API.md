...
```python
class VisionLanguageModel(api_key: str, system_prompt: str, temperature: Optional[float], max_tokens: int, timeout: Optional[int], tools: List[Callable[..., Any]], model: str)
```
