...
```python
class WebSocketMicrophone(port: int, timeout: int, certs_dir_path: str, use_tls: bool, secret: str | None, encrypt: bool, sample_rate: int, channels: int, format: FormatPlain | FormatPacked, buffer_size: int, auto_reconnect: bool)
```
